...
### D. Shareable Result Cards (10 prompts)
...
1. Stop buying trash on Amazon.
2. This product has 4.9 stars, but it’s a lie.
3. How I stopped getting scammed by "verified" reviews.
4. The secret Amazon doesn't want you to know.
5. Your favorite gadget is probably manipulated.
6. Stop trusting the star rating.
...
21. This product has 4.9 stars, but it’s a lie.
22. "They all said it was great..." (Show broken product)
23. This is why your skin cleared up... or didn't.
24. Stop letting bot farms pick your tech.
25. The tool Amazon influencers are scared of.
26. "I thought it was a scam until I used it."
...
34. "It looked so good in the photos."
35. How to be a smart consumer in 2026.
36. The AI that catches the bots.
37. No more buyer's remorse.
...
55. How we analyze 1,000 reviews in 2 seconds.
56. "It's not a scam, it's just 'highly manipulated'."
57. The fine line between marketing and manipulation.
...
68. "Stop! Your Amazon account might be flagged."
...
4. From "Avoid" to "Buy" in under 3 seconds.
5. The simplest tool to protect your wallet from review bots.
6. We find the patterns humans miss.
7. No PII. No Tracking. Just the truth about your next purchase.
8. Because a 4.9 star rating doesn't mean it's a 4.9 star product.
...
4. **Transparent Logic**: Read our MODEL_SPEC to see exactly how we analyze signals.
5. **Zero Selling**: We don't sell your data. We don't take "partnerships" to fix scores.
...
4. It’s a second opinion you can trust.
5. It separates the fans from the bots.
6. It scans for "Verified" badge manipulation.
7. It’s a tool that tells you "Wait, look closer."
8. It finds products that aren't what they claim to be.
9. It’s a simple "Buy" or "Avoid" verdict.
10. It’s 1,000 reviews summarized in 2 seconds.
11. It’s your shopping insurance.
12. It catches the "Review Bursts" while you sleep.
...
4. If we don't have enough data, we say "UNKNOWN". We don't lie.
5. We look for patterns, not "truth". Patterns are verifiable.
6. We don't store your data because we don't want it.
7. We use proxy rotation to ensure we get the same data you see.
8. Our verdicts are based on linguistic repetition, not sentiment.
9. We are a tool for humans, built by skeptics.
10. We don't claim reviews are "fake", we claim they are "suspicious".
...
4. New products don't have enough signals yet.
5. We don't solve captchas. It's for security.
6. Scraping is a cat-and-mouse game. Sometimes we're the mouse.
7. Partial data leads to lower confidence scores.
8. We can't see "deleted" reviews.
9. We don't track your private account data.
10. We are a pattern detector, not a legal witness.
...
15. Stop falling for the 3 AM spikes.
